<?php
    ...
    if (isset($_POST['submit']))
    {
        ...
        else
        {
            ...
            if (!$stmt = $connection->prepare("UPDATE company SET company_name = ? , company_size = ?, company_tags = ?,company_url = ?,company_email = ?,company_phone = ?,country = ?,company_description = ? WHERE id=? "))
            {
            ...
            if (!$stmt->bind_param("ssssssssi", $company_name, $company_size, $company_tags, $company_url, $company_email, $company_phone, $country, $company_description, $id))
            {
                //Print out the error occured
            ...
            else
            {
                ...
                header("Location: edit.php?sucess=done");
