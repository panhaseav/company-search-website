<?php
    ...
    $pagecss = 'createcompany.css';
    //Includes the creatingprocess in this page.
    include "creatingprocess.php";
?>
...
<div class="container">
    ...
    <?php
        ...
        if (isset($_GET['sucess']))
        {
            ...
            if ($_GET['sucess'] == "done")
            {
                ...
                echo "<p class='sucess'>Company Created Sucessfully <br><a href='/wpassignment/existing_company.php'>Click here to check the created company</a> <br> <a href='/wpassignment/admindashboard.php'>Click here for homePage </a></p>";
            }
        }
    ?>
    ...
    <div class="new_user">
        <form  method="post" name="form1" action="createcompany.php">
        ...
        ?>
            ...
            <div class="row">
              ...
              <div class="col-75">
                <input type="text"  name="company_name" placeholder="Enter Company Name.." value="<?php echo $company_name ?>"  minlength="4" maxlength="100" >
              </div>
            </div>
            ...
            ?>
             ...
             <div class="row">
               ...
               <div class="col-75">
                 <input type="text"  name="company_tags" placeholder="Enter the Company Tags.." value="<?php echo $company_tags ?>"  minlength="4" maxlength="100" >
               </div>
             </div>
            <?php
                //Checks that if there is a value error for get.
            ...
            <div class="row">
               ...
               <div class="col-75">
                  <input type="text"  name="company_url" placeholder="Enter the Company URL(eg:www.company.com)" value="<?php echo $company_url ?>"  minlength="5" maxlength="100" >
               </div>
            </div>
            <?php
                //Checks that if there is a value error for get.
            ...
            <div class="row">
              ...
              <div class="col-75">
                <input type="email"  name="company_email" placeholder="Enter Company's Email Address.." value="<?php echo $company_email ?>"  minlength="5" maxlength="100" >
              </div>
            </div>
            <?php
                //Checks that if there is a value error for get.
            ...
            <div class="row">
              ...
              <div class="col-75">
                <input type="tel" name="company_phone" placeholder="Enter Company Contact Number.." value="<?php echo $company_phone ?>"  minlength="10" maxlength="14" >
              </div>
            </div>
            <?php
                    //Checks that if there is a value error for get.
            ...
            <div class="row">
              ...
              <div class="col-75">
                <textarea  name="company_description" placeholder="Describe about the company.." style="height:200px"  minlength="20" maxlength="1000"  spellcheck="true"><?php echo $company_description; ?></textarea>
              </div>
            </div>
            <?php
                //Checks that if there is a value error for get.
